...
class Robot
  ...
  #attributes are defined in initialize(name, type, origin) 
...
david = Robot.new("David", "Super-Android", "New York") # create a new instance called david
travis = Robot.new("travis", "Super-Android", "San Francisco") # create a new instance called david
david.laser_master # access an instance method david(instance).laser_master(instance method) 
travis.laser_master # access an instance method david(instance).laser_master(instance method) 

happy_robot = Robot.random_robot_maker # class method, call the class method on the robot class
happy_robot.fly
